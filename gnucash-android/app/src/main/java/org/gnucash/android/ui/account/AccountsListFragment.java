...
public class AccountsListFragment extends Fragment implements
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        //
        // 创建一个recyclerView的适配器，适配器里包含了数据添加
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        if (mParentAccountUID != null)
            ...
            SearchManager searchManager =
                    (SearchManager) GnuCashApplication.getAppContext()
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        String accountUID = arguments == null ? null : arguments
                .getString(UxArgument.PARENT_ACCOUNT_UID);
    ...
    private static final class AccountsCursorLoader extends DatabaseCursorLoader {
         ...
         * @param parentAccountUID GUID of the parent account
         */
        public AccountsCursorLoader(Context context, String parentAccountUID,
    ...
    class AccountRecyclerAdapter extends CursorRecyclerAdapter<AccountRecyclerAdapter
            .AccountViewHolder> {
        ...
        public void onBindViewHolderCursor(final AccountViewHolder holder, final Cursor cursor) {
            final String accountUID = cursor.getString(cursor
                    .getColumnIndexOrThrow(DatabaseSchema.AccountEntry.COLUMN_UID));
            mAccountsDbAdapter = AccountsDbAdapter.getInstance();
            holder.accoundId = mAccountsDbAdapter.getID(accountUID);

            // 设置"一个，二个，三个"等等
            holder.accountName.setText(cursor.getString(cursor
                    .getColumnIndexOrThrow(DatabaseSchema.AccountEntry.COLUMN_NAME)));
            ...
            new AccountBalanceTask(holder.accountBalance)
                    .executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, accountUID);

            String accountColor = cursor.getString(cursor
                    .getColumnIndexOrThrow(DatabaseSchema.AccountEntry.COLUMN_COLOR_CODE));
        ...
        class AccountViewHolder extends RecyclerView.ViewHolder implements
