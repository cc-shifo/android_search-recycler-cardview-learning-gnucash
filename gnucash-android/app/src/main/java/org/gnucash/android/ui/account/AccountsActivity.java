...
public class AccountsActivity extends BaseDrawerActivity implements OnAccountClickedListener {
    ...
    private class AccountViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int i) {
            AccountsListFragment currentFragment = (AccountsListFragment)
                    mFragmentPageReferenceMap.get(i);
            if (currentFragment == null) {
                switch (i) {
                    ...
                    default:
                        // 这个页面就是我们看到的“一个，二个，三个”等等的那个页面。
                        // 包含了一个recyclerView和空数据的时候显示“没有可以显示的科目”的textView
                        currentFragment = AccountsListFragment.newInstance(
